...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    // 6. eta
    if(nrhs!=6)
	mexErrMsgTxt("The function hps requires 6 inputs.");
    if(nlhs!=1)
	mexErrMsgTxt("The function hps requires 1 output.");
    ...
    if(neta!=1 && meta!=nB)
    	mexErrMsgTxt("The size of the direction of differenetiation must be " 
	    "a vector with size that matches the linear operators.");
    ...
    vector <double> eta(eta_eta,eta_eta+meta);
