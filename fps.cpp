...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    // 4. xi 
    if(nrhs!=4)
	mexErrMsgTxt("The function fps requires 4 inputs.");
    if(nlhs!=1)
	mexErrMsgTxt("The function fps requires 1 output.");
    ...
    vector <double> xi_xi(xi,xi+mxGetM(prhs[3]));
