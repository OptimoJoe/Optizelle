\begin{lstlisting}[style=C++,caption={An example program that minimizes a simple inequality constrained function.  The code for this example can be found under \protect\path{cpp/examples/simple_inequality} in the installation directory.},label=lst:simpleIneq]
