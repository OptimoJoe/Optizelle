...
\chapter{Basic API}\label{ch:Basic}
        ...
        The basic interface to PEOpt is centered around defining the appropriate functions for optimization, settings the appropriate parameters, and then calling the optimization routines.  Each one of these steps has a well-define interface that we define below.
