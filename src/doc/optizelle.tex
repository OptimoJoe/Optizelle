...
\begin{boldlist}
    ...
    \cmakeitem
        ...
        on Windows, we have to include the \textct{mx} library as well.  If
        ...
        \texct{mex} with a semicolon.  For MATLAB, these libraries are
    ...
    \paramitemi
        ...
        \begin{boldlist}
            \ipmitem
                ...
                $$}
        \end{boldlist}
        Implicitly, these choices affect the Hessian modification that we apply during the course of the interior point method.  Nevertheless, in almost all cases, we're better off using the primal-dual interior point method.}
...
\section{\seccustomvector}\label{sec:customvector}
        ...
        In continuous optimization, we most often optimize over a simple vector of numbers in $\re^m$.  If that's the case, we provide a reasonable implementation of this vector space and describe it in section \hyperref[sec:importvs]{\secimportvs}.  However, in some situations we want to use a different space.
\begin{itemize}
