...
$$
        ...
        \end{bmatrix}\delta x.
$$
Generally, we claim using Cramer's rule is a bad idea, but it works fine on this small example.  Using this formulation, we define our preconditioner to the Hessian with the code 
\begin{boldlist}
    \exampleitem
        {C++}
