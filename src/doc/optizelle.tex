...
\begin{center}\begin{tabular}{lll|cccccc}
    ...
    \licenselabelalt{https://github.com/open-source-parsers/jsoncpp}{JsonCpp} & 1.8.4 & \licenseref{Public}{jsoncpp} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ &  & $\checkmark$\\
    \licenselabelalt{http://netlib.org/lapack/}{BLAS/LAPACK} & 3.8.0 & \licenseref{BSD}{blaslapack} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ &  & $\checkmark$\\
    \licenselabelalt{https://cmake.org/}{CMake} & 3.9.6 & \licenseref{BSD}{cmake} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ &  $\checkmark$ & $\checkmark$\\
    \licenselabelalt{http://wixtoolset.org/}{WiX} & 3.10 & \licenseref{MS-RL}{wix} & & & & & & $\checkmark$\\
    \licenselabelalt{https://gcc.gnu.org/}{GCC} & 7.3.0 & \licenseref{GPL}{gcc} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ &  & $\checkmark$\\
    \licenselabelalt{https://www.tug.org/texlive/}{TeX Live} & 2017 & \licenseref{Various}{texlive} & & & & & $\checkmark$ &\\
    \licenselabelalt{https://www.python.org/}{Python} & 2.7.15 & \licenseref{Python}{python} & & $\checkmark$ & & & &\\
    \licenselabelalt{http://www.numpy.org/}{NumPy} & 1.14.5 & \licenseref{BSD}{numpy} & & $\checkmark$ & & & &\\
    \licenselabelalt{https://www.mathworks.com/products/matlab/}{MATLAB} & R2018a & \licenseref{Custom}{matlab} & & & $\checkmark$ & & &\\
    \licenselabelalt{https://github.com/fangq/jsonlab}{JSONlab} & 1.8 & \licenseref{BSD}{jsonlab} & & & $\checkmark$ & $\checkmark$ & &\\
    \licenselabelalt{https://www.gnu.org/software/octave/}{Octave} & 4.4.0 & \licenseref{GPL}{octave} & & & & $\checkmark$ & &\\
