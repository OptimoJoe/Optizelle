...
\begin{boldlist}
    ...
    \exampleitem
        {Optizelle Output}
        {\lstinputlisting[style=OptizelleOutput]{@PROCESSEDPATH@/rosen_output.txt}}
\end{boldlist}
...
\begin{center}
    \lstinputlisting{@PROCESSEDPATH@/mybuild.sh}
\end{center}
...
\begin{boldlist}
    \libraryitem
        ...
        {\textct{MATLABPATH}}
        {\$\{\textctref{CMAKE_INSTALL_PREFIX}\}\textct{/share/optizelle/octave}}
        {\textct{OCTAVE_PATH}}
\end{boldlist}
