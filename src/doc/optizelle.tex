...
\begin{boldlist}
    ...
    \configitem
        ...
        {Windows}
        {MATLAB}
        {Segmentation fault when executing \textct{getMin}}
        {Bug in MATLAB when a string created with \textct{mxCreateString} is passed directly to the Messaging function}
\end{boldlist}
