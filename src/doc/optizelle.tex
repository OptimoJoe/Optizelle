...
\href{https://github.com/fangq/jsonlab}{jsonlab} & Master & Yes & MATLAB/Octave default archive/restart engine\\\hline
...
\begin{boldlist}
    ...
    \exampleitem
        {MATLAB/Octave}
        {\lstinputlisting[style=C++]{@SIMPLESDPCONEPATH@/simple_sdp_cone.m}}
\end{boldlist}
