...
\end{center}
        ...
        As an example, we modify the messaging object in our Rosenbrock advanced API example:
\begin{boldlist}
    \exampleitem
        {C++}
...
\end{boldlist}
        ...
        As an example, we define and use a custom vector space for $\re^m$ in our Rosenbrock advanced API example:
\begin{boldlist}
    \exampleitem
        {C++}
...
\begin{filecontents*}{smanip_solver.cpp}
...
\begin{filecontents*}{smanip_solver.py}
Optizelle.Unconstrained.Algorithms.getMin(X,msg,smanip,fns,state)
Optizelle.EqualityConstrained.Algorithms.getMin(X,Y,msg,smanip,fns,state)
Optizelle.InequalityConstrained.Algorithms.getMin(X,Z,msg,smanip,fns,state)
Optizelle.Constrained.Algorithms.getMin(X,Y,Z,msg,smanip,fns,state)
\end{filecontents*}

\begin{filecontents*}{smanip_solver.m}
...
\begin{boldlist}
    \apiitemshort
        {C++}
        {\lstinputlisting[style=C++]{smanip_solver.cpp}}
        {Use as is}
    \apiitemshort
        {Python}
        {\lstinputlisting[style=Python]{smanip_solver.py}}
        {Use as is}
    \apiitemshort
        {MATLAB/Octave}
        {\lstinputlisting[style=Matlab]{smanip_solver.m}}
        {Use as is}
\end{boldlist}

        As an example, we use the \textctref{StateManipulator} to add restarts to our Rosenbrock advanced API example.  We discuss restarts in the section entitled \hyperref[sec:restart]{\secrestart}. 
\begin{boldlist}
    \exampleitem
        {C++}
...
\indent Each of these situations requires restarts.
        ...
        As long as we use our built-in vector spaces such as \textctref{Rm} and \textctref{SQL}, we can easily read and write restart files to disk.
...
\begin{boldlist}
    \shortexampleitem
        {C++}
        {
        \lstinputlisting[style=C++,linerange={Release0-Release1,Capture0-Capture1},widthgobble=1*4]{@CAPTURERELEASEPATH@/unconstrained.cpp}
        \lstinputlisting[style=C++,linerange={Release0-Release1,Capture0-Capture1},widthgobble=1*4]{@CAPTURERELEASEPATH@/equality_constrained.cpp}
        \lstinputlisting[style=C++,linerange={Release0-Release1,Capture0-Capture1},widthgobble=1*4]{@CAPTURERELEASEPATH@/inequality_constrained.cpp}
        \lstinputlisting[style=C++,linerange={Release0-Release1,Capture0-Capture1},widthgobble=1*4]{@CAPTURERELEASEPATH@/constrained.cpp}
        }
    
    \shortexampleitem
        {Python}
        {
        \lstinputlisting[style=Python,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/unconstrained.py}
        \lstinputlisting[style=Python,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/equality_constrained.py}
        \lstinputlisting[style=Python,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/inequality_constrained.py}
        \lstinputlisting[style=Python,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/constrained.py}
        }
    
    \shortexampleitem
        {MATLAB/Octave}
        {
        \lstinputlisting[style=Matlab,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/unconstrained.m}
        \lstinputlisting[style=Matlab,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/equality_constrained.m}
        \lstinputlisting[style=Matlab,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/inequality_constrained.m}
        \lstinputlisting[style=Matlab,linerange={Release0-Release1,Capture0-Capture1}]{@CAPTURERELEASEPATH@/constrained.m}
        }
\end{boldlist}

        Outside the use of capture and release, we can simplify the restart scheme further.  Specifically, as long as we 
