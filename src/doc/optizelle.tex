...
\begin{center}\begin{tabular}{|p{.2\textwidth}|p{.1\textwidth}|p{.1\textwidth}|p{.5\textwidth}|}\hline
...
\href{http://www.netlib.org/lapack}{BLAS and LAPACK} & $\geq$ 3.4.2 & No & Dense kernels for the default vector spaces in the C++ interface\\\hline
...
\begin{center}\begin{tabular}{|p{.15\textwidth}|p{.25\textwidth}|p{.2\textwidth}|p{.3\textwidth}|}\hline
{\bf Compiler} & {\bf Language} & {\bf Platform} & {\bf Download Location}\\\hline
GCC $\geq 4.7$ & C++11, FORTRAN 77 & Linux, Unix, OS X & \url{http://gcc.gnu.org}\\\hline
Clang & C++11 & Linux, Unix, OS X & \url{http://clang.llvm.org}\\\hline
DragonEgg & C++11, FORTRAN 77 & Linux, Unix, OS X & \url{http://dragonegg.llvm.org}\\\hline
MinGW & C++11, FORTRAN 77 & Windows & \url{http://www.mingw.org}\\\hline
Cygwin (GCC) & C++11, FORTRAN 77 & Windows & \url{http://www.cygwin.com}\\\hline
\end{tabular}\end{center}
...
\begin{center}\begin{tabular}{|p{.2\textwidth}|p{.2\textwidth}|p{.5\textwidth}|}\hline
{\bf Make} & {\bf Platform} & {\bf Download Location}\\\hline
GNU Make & Linux, Unix, OS X & \url{https://www.gnu.org/software/make}\\\hline
MSYS & Windows & \url{http://www.mingw.org}\\\hline
Cygwin (GNU Make) & Windows & \url{http://www.cygwin.com}\\\hline
NMake & Windows & \url{http://msdn.microsoft.com/en-us/vstudio}\\\hline
\end{tabular}\end{center}
...
\begin{center}\begin{tabular}{|p{.3\textwidth}|p{.6\textwidth}|}\hline
{\bf BLAS/LAPACK Library} & {\bf Download Location}\\\hline
ATLAS & \url{http://math-atlas.sourceforge.net}\\\hline
Intel MKL & \url{http://software.intel.com/en-us/intel-mkl}\\\hline
AMD ACML & \url{http://developer.amd.com/tools-and-sdks/cpu-development/amd-core-math-library-acml}\\\hline
Goto BLAS & \url{https://www.tacc.utexas.edu/tacc-projects/gotoblas2}\\\hline
\end{tabular}\end{center}
