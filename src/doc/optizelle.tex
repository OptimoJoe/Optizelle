...
\begin{boldlist}
    ...
    \paramitemu
        ...
        {Natural}
        {No}
        {Number of failed safe-guard steps during the last iteration.  We output \textctref{safeguard_failed} at each iteration under the label \textctrefalt{failed_safe}.}
