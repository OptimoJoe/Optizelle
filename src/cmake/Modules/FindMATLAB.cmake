...
set(MATLAB_EXECUTABLE ${MEX_UNDEFINED} CACHE STRING
    "MATLAB executable with command line flag to run a script (-r in MATLAB and --eval in Octave).  For example, /some/path/matlab -r or /another/path/octave --eval.")
# Make sure that it is defined and throw an error message if it is not
if(MATLAB_EXECUTABLE STREQUAL MEX_UNDEFINED) 
    mark_as_advanced(CLEAR MATLAB_EXECUTABLE)
    message(FATAL_ERROR
        "The MATLAB executable with command line flag to run a script must be defined in the variable MATLAB_EXECUTABLE.")
endif()
...
if(MATLAB_RUN_FLAG STREQUAL MEX_UNDEFINED) 
    ...
    message(FATAL_ERROR
        "The MATLAB command line flag to run a script must be defined in the variable MATLAB_RUN_FLAG.")
endif()
